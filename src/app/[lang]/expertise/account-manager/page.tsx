...
const amTerms = [
  {
    ...
    content:
      'Within 48 hours of signing, your AM leads a comprehensive 90-minute onboarding session. We map your business goals, KPIs, internal stakeholders, brand guidelines, competitive landscape, and every tool in your current stack. Nothing is left to assumption.',
  },
  {
    title: 'Shared Workspace Setup',
    content:
      'We provision a private Slack channel, a shared Notion workspace for documentation and sprint tracking, and configure weekly calendar invites for recurring strategy sessions. Your AM also sets up a shared Loom library for async video updates.',
  },
  {
    title: 'Internal Advocacy',
    content:
      'Your AM is not a messenger. They are your internal advocate who fights for your priorities within our engineering, design, and strategy teams. They coordinate all cross-functional work behind the scenes so you only deal with one person who delivers results.',
  },
  {
    title: 'Proactive Reporting',
    content:
      'Your AM doesn\'t wait for you to ask "how are things going?" They deliver weekly performance snapshots, anomaly alerts, and strategic recommendations before you even think to ask. If something is trending down, you hear about it first — with a solution already attached.',
  },
  {
    title: 'Backup & Continuity',
    content:
      'Every Account Manager has a designated backup who is briefed on all active accounts. Before any leave, your AM will introduce you to their backup and ensure a seamless transition. You will never be left without a direct point of contact.',
  },
  {
    title: 'Reassignment Policy',
    content:
      "If at any point you feel the chemistry or expertise isn't right, you can request a reassignment. We will transition you to a new AM within 5 business days with a full context handover document to ensure zero information loss.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative w-full pt-40 pb-24 px-6 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <span className="text-[13px] font-medium text-black/50 tracking-wide uppercase">
              Expertise
            </span>
          </div>

          <h1
            className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-medium tracking-[-0.04em] text-[#2f5b7c] leading-[0.9] mb-12 opacity-0 animate-fade-in-up"
          ...
          <p
            className="max-w-2xl text-lg sm:text-xl text-black/60 font-light leading-relaxed opacity-0 animate-fade-in-up"
            style={{ animationDelay: '0.3s' }}
          >
            You will never chase a support ticket. Every LightningRevenue client
            is assigned a senior Account Manager who acts as your single point
            of contact, internal advocate, and strategic partner — from day one
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-black/50 font-light text-lg max-w-2xl mx-auto">
              This isn't a junior coordinator forwarding your emails. This is a
              senior strategist who understands your industry and owns your
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {amMetrics.map((item, idx) => (
              ...
              >
                ...
                <span className="text-4xl sm:text-5xl font-medium text-[#2f5b7c] mb-2 relative z-10">
                  {item.metric}
                </span>
                <span className="text-sm font-bold text-black/80 uppercase tracking-widest mb-4 relative z-10">
                  {item.label}
                </span>
                <p className="text-black/50 font-light leading-relaxed text-sm relative z-10">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <section className="relative w-full py-24 px-6 bg-[#fafafa] border-t border-black/5">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <div className="text-xs font-bold text-black/40 mb-6 uppercase tracking-widest">
            ...
            <p className="text-black/50 font-light text-lg max-w-2xl">
              Your Account Manager is accountable for every touchpoint. Here is
              the exact scope of their ownership across your engagement.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-black/10 bg-white overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
            ...
            <div className="grid grid-cols-4 px-8 py-6 border-b border-black/5 items-center hover:bg-[#fafafa] transition-colors">
              ...
              <span className="text-black/60 font-light text-sm">
                KPI reviews, sprint planning, pivots
              </span>
            ...
            <div className="grid grid-cols-4 px-8 py-6 border-b border-black/5 items-center hover:bg-[#fafafa] transition-colors">
              ...
              <span className="text-black/60 font-light text-sm">
                Updates, blockers, async questions
              </span>
            ...
            <div className="grid grid-cols-4 px-8 py-6 border-b border-black/5 items-center hover:bg-[#fafafa] transition-colors">
              ...
              <span className="text-black/60 font-light text-sm">
                Performance snapshots, anomaly alerts
              </span>
              <span className="font-medium text-black">Weekly</span>
            ...
            <div className="grid grid-cols-4 px-8 py-6 items-center hover:bg-[#fafafa] transition-colors">
              ...
              <span className="text-black/60 font-light text-sm">
                Critical incidents, SLA breaches
              </span>
              ...
              return (
                <div key={index} className="border-b border-black/10">
                  ...
                  >
                    ...
                    <span
                      className={`flex-shrink-0 w-8 h-8 flex items-center justify-center border border-black/10 rounded-full transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? 'rotate-45 bg-black text-white border-black' : 'text-black group-hover:border-black/30'}`}
                    >
                      <svg
      ...
      <section className="relative w-full py-24 px-6 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="relative z-10 text-white/60 font-light text-lg mb-12 max-w-xl mx-auto">
            Stop dealing with anonymous support queues. Get a named strategist
            who treats your business like their own.
          </p>
          <a
