...
export default function DevContact() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await submitServiceRequest({ service: "web-development", ...formData });
      setIsSubmitted(true);
      setPhase(1);
  ...
  return (
    <section id="contact-dev" className="relative z-10 py-32 px-6 bg-white w-full border-t border-black/5">
