      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-20 max-w-3xl">
          ...
          <p className="text-black/50 font-light text-lg">
            Cold outreach is purely a math and infrastructure game. We configure the tech stack so your sales team can focus on closing deals, not fighting spam filters.
          </p>
        </div>
        ...
        <div className="w-full relative rounded-3xl overflow-hidden bg-black text-white p-10 sm:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 border border-black/10 shadow-2xl">
          ...
          <div className="relative z-10 flex-1">
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-6 leading-[1.1]">
              How powerful is an <br className="hidden sm:block"/> automated sales machine?
            </h3>
            <p className="text-white/70 font-light leading-relaxed max-w-xl text-lg">
              When infrastructure is technically flawless, volume becomes your ultimate advantage. A properly architected outbound engine allows your team to execute <strong className="text-white font-medium">thousands of automated touches per day</strong>, maintaining absolute perfect sender reputation and <strong className="text-white font-medium">100% inbox placement</strong>.
            </p>
          </div>
          ...
          <div className="relative z-10 shrink-0 w-full lg:w-auto flex flex-col sm:flex-row items-center gap-6">
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">100<span className="text-[#2f5b7c]">%</span></span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Inbox Rate</span>
            </div>
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-4xl sm:text-5xl font-medium text-white mb-1">Scale</span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Infinite Volume</span>
            </div>
          </div>
        </div>
