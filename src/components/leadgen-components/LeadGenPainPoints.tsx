      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center sm:text-left">
          ...
          <p className="text-black/50 font-light text-lg max-w-2xl">
            Outbound sales isn't about hustle anymore. It's a technical
            engineering problem. We build the infrastructure to scale your
            outreach without breaking your domain.
          </p>
        </div>
