      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-20 max-w-3xl">
          ...
          <p className="text-black/50 font-light text-lg">
            We eliminate manual busywork. By connecting your CRM, dialer, and calendar via APIs, we give your sales team their time back to do what they do best: sell.
          </p>
        </div>
        ...
        <div className="w-full relative rounded-3xl overflow-hidden bg-black text-white p-10 sm:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 border border-black/10 shadow-2xl">
          ...
          <div className="relative z-10 flex-1">
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-6 leading-[1.1]">
              How much time is lost <br className="hidden sm:block"/> to manual data entry?
            </h3>
            <p className="text-white/70 font-light leading-relaxed max-w-xl text-lg">
              Sales reps are highly paid professionals, not data entry clerks. By properly architecting your RevOps stack, we typically recover <strong className="text-white font-medium">15 hours per rep, per week</strong>, while simultaneously achieving absolute <strong className="text-white font-medium">100% data accuracy</strong> across your entire pipeline.
            </p>
          </div>
          ...
          <div className="relative z-10 shrink-0 w-full lg:w-auto flex flex-col sm:flex-row items-center gap-6">
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">15<span className="text-[#2f5b7c]">h</span></span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Saved Weekly</span>
            </div>
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">100<span className="text-[#2f5b7c]">%</span></span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Data Accuracy</span>
            </div>
          </div>
        </div>
