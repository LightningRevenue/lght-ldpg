      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center sm:text-left">
          ...
          <p className="text-black/50 font-light text-lg max-w-2xl">
            You can't scale a sales team on spreadsheets and manual entry. We
            engineer RevOps infrastructure that eliminates friction and enforces
            absolute data discipline.
          </p>
        </div>
