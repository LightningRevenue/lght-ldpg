...
const painPoints = [
  "Sales reps wasting 60% of their day manually logging data instead of actually talking to prospects.",
  "Emails constantly landing in spam because your DNS records (SPF, DKIM, DMARC) are completely misconfigured.",
  "Highly fragmented tool stacks where your calendar, email, and CRM refuse to sync properly with one another.",
  "Losing high-ticket deals because there are zero automated follow-up sequences or task reminders in place.",
];

const outcomes = [
  "Fully automated data entry. When a call ends, transcripts and action items sync directly to the CRM.",
  "Bulletproof email deliverability with perfectly configured DNS infrastructure across all your company domains.",
  "A centralized, unified tech stack where Zapier and Webhooks connect every single application seamlessly.",
  "Algorithmic pipeline management that automatically triggers follow-up tasks based on specific deal stages.",
];

export default function SalesSetupPainPoints() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center sm:text-left">
          ...
          <p className="text-black/50 font-light text-lg max-w-2xl">
            You can't scale a sales team on spreadsheets and manual entry. We engineer RevOps infrastructure that eliminates friction and enforces absolute data discipline.
          </p>
        </div>
