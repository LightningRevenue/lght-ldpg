      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-20 max-w-3xl">
          ...
          <p className="text-black/50 font-light text-lg">
            We don't just "build links" or write generic blogs. We engineer organic authority. Every piece of content and line of code is optimized to capture pure search intent.
          </p>
        </div>
        ...
        <div className="w-full relative rounded-3xl overflow-hidden bg-black text-white p-10 sm:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 border border-black/10 shadow-2xl">
          ...
          <div className="relative z-10 flex-1">
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-6 leading-[1.1]">
              How much can you grow <br className="hidden sm:block"/> with elite SEO?
            </h3>
            <p className="text-white/70 font-light leading-relaxed max-w-xl text-lg">
              When technical foundations are flawless and content perfectly aligns with search intent, organic traffic becomes a compounding asset. A properly architected SEO strategy typically yields a <strong className="text-white font-medium">400% increase in non-branded organic traffic</strong> within 6 months, while drastically reducing your long-term dependence on paid acquisition.
            </p>
          </div>
          ...
          <div className="relative z-10 shrink-0 w-full lg:w-auto flex flex-col sm:flex-row items-center gap-6">
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">400<span className="text-[#2f5b7c]">%</span></span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">More Traffic</span>
            </div>
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">Zero</span>
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Ad Spend</span>
            </div>
          </div>
        </div>
