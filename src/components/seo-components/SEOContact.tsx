...
export default function SEOContact() {
  ...
  const handleSubmit = () => {
    alert("Audit request submitted! We'll be in touch shortly.");
    setPhase(1);
    setFormData({ challenge: '', budget: '', website: '', name: '', email: '' });
  };

  return (
    <section id="contact-seo" className="relative z-10 py-32 px-6 bg-white w-full border-t border-black/5">
            ...
            <div className="max-w-xl mx-auto w-full h-full flex flex-col justify-center">
              ...
              {phase === 1 && (
                <div className="animate-fade-in-up w-full">
                  <h3 className="text-2xl sm:text-3xl font-medium mb-2 text-black">What's the main SEO issue?</h3>
                  <p className="text-black/50 font-light mb-8">Before we look at the code, tell us what's hurting your organic growth.</p>
                  
                  <textarea 
                    value={formData.challenge}
                    onChange={(e) => setFormData({...formData, challenge: e.target.value})}
                    placeholder="e.g. We lost traffic after the last core update, or we rank well but get zero leads..."
              ...
              {phase === 2 && (
                <div className="animate-fade-in-up w-full">
                  <h3 className="text-2xl sm:text-3xl font-medium mb-2 text-black">Monthly Marketing Budget</h3>
                  <p className="text-black/50 font-light mb-8">This helps us assign the right technical strategist to your audit.</p>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {['Under $5,000', '$5,000 - $15,000', '$15,000 - $30,000', '$30,000+'].map(budgetTier => (
                      <button 
                        key={budgetTier}
              ...
              {phase === 3 && (
                <div className="animate-fade-in-up w-full">
                  <h3 className="text-2xl sm:text-3xl font-medium mb-2 text-black">Where should we crawl?</h3>
                  <p className="text-black/50 font-light mb-8">Drop your main URL so we can run an initial technical analysis.</p>
              ...
              {phase === 4 && (
                <div className="animate-fade-in-up w-full text-center">
                  ...
                  <p className="text-black/50 font-light mb-10">We'll crawl your setup and email you a direct video breakdown.</p>
