...
export default function SMMContact() {
  ...
  const handleSubmit = () => {
    alert("Content Audit request submitted! We'll be in touch shortly.");
    setPhase(1);
    setFormData({ challenge: '', budget: '', socialUrl: '', name: '', email: '' });
  };

  return (
    <section id="contact-smm" className="relative z-10 py-32 px-6 bg-white w-full border-t border-black/5">
