        ...
        <div className="w-full relative rounded-3xl overflow-hidden bg-black text-white p-10 sm:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 border border-black/10 shadow-2xl">
          ...
          <div className="relative z-10 flex-1">
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight mb-6 leading-[1.1]">
              How much revenue is hidden <br className="hidden sm:block"/> in bad design?
            </h3>
            <p className="text-white/70 font-light leading-relaxed max-w-xl text-lg">
              When users are confused, they leave. When an interface feels premium and intuitive, trust skyrockets. A properly architected UX redesign typically yields a <strong className="text-white font-medium">35% higher checkout conversion rate</strong> within the first 60 days, while completely unifying your visual identity across all platforms.
            </p>
          </div>
          ...
          <div className="relative z-10 shrink-0 w-full lg:w-auto flex flex-col sm:flex-row items-center gap-6">
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              <span className="text-5xl font-medium text-white mb-1">35<span className="text-[#2f5b7c]">%</span></span>
            ...
            <div className="flex flex-col items-center justify-center w-full sm:w-48 h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
              ...
              <span className="text-xs tracking-widest text-white/50 uppercase font-medium">Consistency</span>
            </div>
          </div>
        </div>
