...
export default function UIUXContact() {
  ...
  const handleSubmit = () => {
    alert("UX Audit request submitted! We'll be in touch shortly.");
    setPhase(1);
    setFormData({ challenge: '', budget: '', appUrl: '', name: '', email: '' });
  };

  return (
    <section id="contact-uiux" className="relative z-10 py-32 px-6 bg-white w-full border-t border-black/5">
