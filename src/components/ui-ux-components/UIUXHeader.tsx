...
export default function UIUXHeader() {
  const t = getServicesDictionary(getLanguageFromPathname(usePathname())).uiUx.hero;
    ...
    <section className="relative w-full h-screen sticky top-0 overflow-hidden bg-[#fafafa] z-0">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-10 sm:mb-16 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <span className="text-[13px] font-medium text-black/50 tracking-wide uppercase">{t.eyebrow}</span>
        </div>
